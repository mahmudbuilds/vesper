...
// SVG Icons helper for Vesper
const icons = {
  vesperLogo: `<svg class="size-4 shrink-0 fill-current" viewBox="0 0 24 24"><path d="M12 2L2 19.5h20L12 2zm0 4.5l6.5 11.5h-13L12 6.5z"/><polygon points="12 9 8.5 15.5 15.5 15.5"/></svg>`,
  windows: `<svg class="size-4 shrink-0 fill-current" viewBox="0 0 24 24"><path d="M0 3.449L9.75 2.1v9.451H0m10.949-9.602L24 0v11.4H10.949M0 12.6h9.75v9.451L0 20.699M10.949 12.6H24V24l-12.9-1.801"/></svg>`,
  apple: `<svg class="size-4 shrink-0 fill-current" viewBox="0 0 24 24"><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.81-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M15.97 6.37c.62-.75 1.04-1.8 0.92-2.85-.9.04-2 .6-2.64 1.35-.57.65-1.06 1.73-.93 2.76 1.01.08 2.03-.51 2.65-1.26z"/></svg>`,
  sparkles: `<svg class="size-3.5 shrink-0 text-blue-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.582a.5.5 0 0 1 0-.962L8.5 9.936A2 2 0 0 0 9.937 8.5l1.582-6.135a.5.5 0 0 1 .963 0L14.063 8.5A2 2 0 0 0 15.5 9.937l6.135 1.581a.5.5 0 0 1 0 .964L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.582 6.135a.5.5 0 0 1-.963 0z"/><path d="M20 3v4"/><path d="M22 5h-4"/><path d="M4 17v2"/><path d="M5 18H3"/></svg>`,
  wand: `<svg class="size-3.5 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m21.64 3.64-1.28-1.28a1.21 1.21 0 0 0-1.72 0L2.36 18.64a1.21 1.21 0 0 0 0 1.72l1.28 1.28a1.2 1.2 0 0 0 1.72 0L21.64 5.36a1.2 1.2 0 0 0 0-1.72"/><path d="m14 7 3 3"/><path d="M5 6v4"/><path d="M19 14v4"/><path d="M10 2v2"/><path d="M7 8H3"/><path d="M21 16h-4"/><path d="M11 3H9"/></svg>`,
  messageSquare: `<svg class="size-3.5 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>`,
  refresh: `<svg class="size-3.5 shrink-0 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16"/><path d="M8 16H3v5"/></svg>`,
  zap: `<svg class="size-3 text-white/70" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/></svg>`,
  shield: `<svg class="size-3.5 text-emerald-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/><path d="m9 12 2 2 4-4"/></svg>`,
  chevronDown: `<svg class="size-3.5 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m6 9 6 6 6-6"/></svg>`,
  eyeOff: `<svg class="size-4 text-gray-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9.88 9.88a3 3 0 1 0 4.24 4.24"/><path d="M10.73 5.08A10.43 10.43 0 0 1 12 5c7 0 10 7 10 7a13.16 13.16 0 0 1-1.67 2.68"/><path d="M6.61 6.61A13.526 13.526 0 0 0 2 12s3 7 10 7a9.74 9.74 0 0 0 5.39-1.61"/><line x1="2" x2="22" y1="2" y2="22"/></svg>`,
  command: `<svg class="size-3 text-gray-700" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6v12a3 3 0 1 0 3-3H6a3 3 0 1 0 3 3V6a3 3 0 1 0-3 3h12a3 3 0 1 0-3-3"/></svg>`,
  code: `<svg class="size-3.5 text-cyan-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>`,
  cpu: `<svg class="size-3.5 text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="4" width="16" height="16" rx="2"/><rect x="9" y="9" width="6" height="6"/><line x1="9" y1="1" x2="9" y2="4"/><line x1="15" y1="1" x2="15" y2="4"/><line x1="9" y1="20" x2="9" y2="23"/><line x1="15" y1="20" x2="15" y2="23"/><line x1="20" y1="9" x2="23" y2="9"/><line x1="20" y1="14" x2="23" y2="14"/><line x1="1" y1="9" x2="4" y2="9"/><line x1="1" y1="14" x2="4" y2="14"/></svg>`,
  check: `<svg class="size-3.5 text-emerald-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"/></svg>`,
};

// Response scenarios for interactive typewriter
const scenarios = {
      ...
      <div class="gray-assist-card p-6 sm:p-8 md:p-9 text-[#19191D] flex flex-col justify-between min-h-[460px] relative overflow-hidden slide-right-init delay-150">
        ...
        <div class="cluely-dark-hud p-4 text-white shadow-2xl rounded-2xl">
          ...
          <div class="flex flex-wrap items-center gap-2 pt-3 pb-2 text-[10px] text-gray-400">
            <span class="flex items-center gap-1 text-gray-300">${icons.sparkles} O(1) Time</span>
            <span>·</span>
            <span class="flex items-center gap-1">${icons.wand} What to say</span>
            <span>·</span>
            <span class="flex items-center gap-1">${icons.messageSquare} Edge Cases</span>
            <span>·</span>
            <span class="flex items-center gap-1">${icons.refresh} System Design</span>
          </div>
            ...
            <div id="slider-foreground" class="absolute inset-0 overflow-hidden bg-[#16171D]" style="width: 50%;">
              ...
              <div class="absolute top-10 left-3 right-3 rounded-xl bg-black/90 p-3 shadow-xl border border-blue-500/40 text-gray-200 text-[10px] font-sans z-10 backdrop-blur-md">
                <div class="flex items-center justify-between font-semibold text-blue-400 pb-1 border-b border-white/10">
                  <span class="flex items-center gap-1">${icons.sparkles} Vesper Hint</span>
    ...
    <div class="space-y-4 font-sans text-sm">
      <div class="border-b border-gray-200 pb-4 slide-left-init delay-100">
        <button class="faq-question w-full flex items-center justify-between py-2 text-left font-medium text-base sm:text-lg text-gray-900 hover:text-blue-600 transition-colors">
          ...
          <span class="faq-chevron transition-transform duration-300 text-gray-400">${icons.chevronDown}</span>
        </button>
...
// ==============================================
// SMOOTH INTERACTIVE ENGINE
// ==============================================

// 1. Ultra-Smooth Mouse Parallax Tilt with Lerp Smoothing
...
if (heroSection && tiltCard) {
  heroSection.addEventListener('mousemove', (e) => {
    ...
    targetRotateY = (x / (rect.width / 2)) * 3.5;
    targetRotateX = -(y / (rect.height / 2)) * 3.5;
  });
  ...
  function animateTilt() {
    ...
    tiltCard.style.transform = `rotateX(${currentRotateX.toFixed(2)}deg) rotateY(${currentRotateY.toFixed(2)}deg)`;
    requestAnimationFrame(animateTilt);
  }
  requestAnimationFrame(animateTilt);
}

// 2. Typewriter Streaming Text Engine with Human Punctuation Delays
...
function streamText(text) {
  ...
  function typeChar() {
    if (index < text.length) {
      streamingTextEl.textContent += text[index];
      ...
      streamTimeout = setTimeout(typeChar, delay);
    }
  }
  typeChar();
}

streamText(scenarios.optimal);
...
chips.forEach(chip => {
  chip.addEventListener('click', () => {
    ...
    if (scenarios[key]) streamText(scenarios[key]);
  });
});

// Custom Question Handler
const hudInput = document.getElementById('hud-input');
const hudSubmit = document.getElementById('hud-submit');

function handleCustomQuestion() {
  const query = hudInput.value.trim();
  if (!query) return;
  streamText(`"Analyzing: '${query}'. Vesper Recommendation: Use two-pointer traversal to prune branches in O(1) space, avoiding hash map overhead."`);
  hudInput.value = '';
}

if (hudSubmit && hudInput) {
  hudSubmit.addEventListener('click', handleCustomQuestion);
  hudInput.addEventListener('keydown', (e) => {
    if (e.key === 'Enter') handleCustomQuestion();
  });
}

// 3. Fluid Sinusoidal Wave Telemetry Visualizer
const barsContainer = document.getElementById('audio-bars-row');
const barCount = 36;
const bars = [];
...
if (barsContainer) {
  for (let i = 0; i < barCount; i++) {
    ...
    bar.className = 'w-1 sm:w-1.5 rounded-full bg-white/70 transition-all duration-75';
    bar.style.height = '20%';
  ...
  setInterval(() => {
    bars.forEach((bar, idx) => {
      const wave = Math.sin(phase + idx * 0.32) * 0.35 + Math.cos(phase * 0.7 + idx * 0.15) * 0.2 + 0.5;
      const heightPercent = Math.max(12, Math.min(100, Math.floor(wave * 95)));
      bar.style.height = `${heightPercent}%`;
      bar.style.opacity = `${0.35 + wave * 0.65}`;
    });
    phase += 0.22;
  }, 75);
}
...
let recSeconds = 0;
const recCounter = document.getElementById('recording-counter');
setInterval(() => {
  recSeconds++;
  const m = String(Math.floor(recSeconds / 60)).padStart(2, '0');
  const s = String(recSeconds % 60).padStart(2, '0');
  if (recCounter) recCounter.textContent = `${m}:${s}`;
}, 1000);

// 4. Draggable Screen Share Slider with Pointer Damping
...
function updateSlider(clientX) {
  ...
  sliderForeground.style.width = `${pct}%`;
...
// 5. Tactile Moveable Window Controller
const moverBox = document.getElementById('hud-mover-box');
let posX = 15;
let posY = 25;

document.getElementById('move-left')?.addEventListener('click', () => {
  posX = Math.max(5, posX - 12);
  if (moverBox) moverBox.style.left = `${posX}%`;
});
document.getElementById('move-right')?.addEventListener('click', () => {
  posX = Math.min(45, posX + 12);
  if (moverBox) moverBox.style.left = `${posX}%`;
});
document.getElementById('move-up')?.addEventListener('click', () => {
  posY = Math.max(10, posY - 12);
  if (moverBox) moverBox.style.top = `${posY}px`;
});
document.getElementById('move-down')?.addEventListener('click', () => {
  posY = Math.min(70, posY + 12);
  if (moverBox) moverBox.style.top = `${posY}px`;
});

// 6. Smooth Hardware-Accelerated Accordion FAQ
document.querySelectorAll('.faq-question').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    document.querySelectorAll('.accordion-wrapper').forEach(w => w.classList.remove('open'));
...
// 7. 10X Buttery Smooth Sliding Entrance Observer
...
// Orchestrated Hero Slide-In on Load
window.addEventListener('DOMContentLoaded', () => {
  setTimeout(() => {
    document.querySelectorAll('#hero-section .slide-up-init, #hero-section .slide-scale-init').forEach(el => {
      el.classList.add('slide-active');
    });
  }, 100);
});
